...
INSERT IGNORE INTO Players(ID, Name) VALUES (1, "Rubix327"), (2, "Foldner"), (3, "_Pa3eTka_");
...
INSERT IGNORE INTO TownWorkers(ID, Player, Town, WorkerType, DisplayName, Salary) VALUES (1, 1, 1, 1, "Mayor", 100),
(2, 3, 1, 2, "Mayor", 50), (3, 2, 2, 1, "Helper", 200);
...
INSERT IGNORE INTO Reputations(ID, Player, Town, Amount) VALUES (1, 1, 1, 0), (2, 2, 1, 100), (3, 3, 2, 50);
