...
INSERT IGNORE INTO TownWorkers(ID, Player, Town, WorkerType, DisplayName, Salary) VALUES (1, 2, 1, 1, "Mayor", 100),
(2, 3, 1, 2, "Mayor", 50), (3, 4, 2, 1, "Helper", 200);
...
(1, 1, 1, 2, "EasyTask", "Bring me some vegetables", 5, 1, 30, 100, 15, 5, "2022-04-22", 60, 2),
(2, 3, 1, 3, "For Low Skills", "Army supply!", 1, 1, 30, 200, 30, 20, "2022-04-23 00:00:00", 5, 1),
(3, 4, 2, 4, "Make it faster", "Harder, better, faster, stronger", 20, 10, 20, 500, 200, 150, "2022-04-22 21:15:11", 20, 1);
