...
public class DataManager {
    ...
    public static void setValue(Task task, String variable, Object value) {
        switch (variable) {
            case ("task_name"):
                task.setTaskName(String.valueOf(value));
            case ("description"):
                task.setDescription(String.valueOf(value));
            case ("take_amount"):
                task.setTakeAmount((int) value);
            case ("min_level"):
                task.setMinLevel((int) value);
            case ("max_level"):
                task.setMaxLevel((int) value);
            case ("reputation_reward"):
                task.setReputationReward((int) value);
            case ("priority"):
                task.setReputationReward((int) value);
            case ("money_reward"):
                task.setMoneyReward((double) value);
            case ("exp_reward"):
                task.setExpReward((double) value);
        }
    }
...
//        }
    ...
    public static boolean isTownExists(String townName) {
