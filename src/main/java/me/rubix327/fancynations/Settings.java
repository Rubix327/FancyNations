...
public class Settings extends SimpleSettings {
    ...
    private static void init(){
        ...
        setPathPrefix("Professions.Mayor");
        ...
        setPathPrefix("Professions.Helper");
        ...
        setPathPrefix("Professions.Other");
        ...
        setPathPrefix("Messages_Templates");
